...
<div class="card card-bordered table-responsive mt-3 p-5 card-preview">
    <form action="{{ route('listing.export.group.update', ['id' => $dataGroup->id]) }}" method="POST">
            ...
            <div class="col-lg-6">
                <div class="form-group">
                    ...
                    <div class="form-control-wrap">
                        <input placeholder="Group Name" type="text" value='{{ $dataGroup->group_name }}' class="form-control" id="name" name='name' required>
                    </div>
                </div>
            </div>
            <div class="col-lg-6">
        ...
        <div class="form-group mt-3"><button type="submit" class="btn btn-sm btn-primary">UPDATE GROUP</button><a href="{{ route('listing.export.group.index') }}" class="btn ml-2 btn-sm btn-secondary">CANCEL</a></div>
    </form>
</div>
@endsection