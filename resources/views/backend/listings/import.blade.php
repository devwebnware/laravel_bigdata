            ...
            <div class="modal-content">
                <form id="importDataForm" enctype="multipart/form-data">
                    ...
                    <div class="modal-footer">
                        <div class="mt-2 w-30">
                            <input type="number" id="chunkSize" class="form-control" name="chunkSize"
                                placeholder="Enter Chunk Size (Default is 500)" />
                        </div>
                        <div class="mt-2">
                            <a href="#" class="btn close-btn btn-info" data-dismiss="modal" aria-label="Close">
                                Close
                            </a>
                            <button type="submit" class="btn btn-info">IMPORT</button>
                            <button type="button" class="btn clear-btn btn-secondary">CLEAR</button>
                        </div>
                    </div>
                </form>
            </div>
        ...
        <script>
            ...
            $(document).ready(function() {
                $("#importDataForm").on("submit", function(e) {
                    ...
                    formData.append('data', chunkSize);
