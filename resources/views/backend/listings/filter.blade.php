...
<div class="d-flex flex-row">
    <a href="{{ route('listings.data.export')}}" class='btn btn-secondary mr-2'>Export Filtered Data</a>
    ...
    <div class="ml-auto">
        <a href="{{ route('listings.create')}}" class='btn btn-info mr-auto'>Add Listing</a>
    </div>
</div>
<!-- Start Filter Modal -->
